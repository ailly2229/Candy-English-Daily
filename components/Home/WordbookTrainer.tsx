    ...
    <section className="py-10">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        {levels.map((level) => (
          <CandyCard
            key={level.slug}
            className="group overflow-hidden p-5 transition hover:-translate-y-1 hover:shadow-[0_20px_50px_rgba(31,41,55,0.12)]"
          >
            ...
            <h3 className="mt-5 text-xl font-black text-slate-950">{level.title}</h3>
            <p className="mt-2 min-h-12 text-sm font-bold leading-6 text-slate-500">{level.description}</p>
